...
# with command line options: step3 --runUnscheduled --conditions auto:run2_mc -s RAW2DIGI,L1Reco,RECO --datatier GEN-SIM-RECO -n 10 --era Run2_2016 --eventcontent RECOSIM --filein file:step2.root --fileout file:step3.root --no_exec
